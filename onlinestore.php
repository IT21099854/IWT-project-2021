          ...
          <section class="span12 first">
            ...
            <section class="grid-holder features-books">
                ...
                ?>
                    <figure class="span4 slide first">
                        <a href="book-detail.php?bookid=<?php echo $row["id"]; ?>"><img src="<?php echo $row["image"]; ?>" alt="" class="pro-img" style="width:330px; height:320px"/></a>
            ...
            <div class="blog-footer">
            	<div class="pagination">  
                  <ul>  
                    <li><a href="onlinestore.php?page=<?php echo $_GET['page'] - 1;?>">Prev</a></li>   
                    <?php
                        for ($page = 1; $page <= $number_of_page; $page++) {
                            echo '<li><a href = "onlinestore.php?page=' . $page . '">' . $page . ' </a></li>';
                        }
                    ?> 
                    <li><a href="onlinestore.php?page=<?php echo $_GET['page'] + 1;?>">Next</a></li>  
                  </ul>  
                </div>
            </div>
