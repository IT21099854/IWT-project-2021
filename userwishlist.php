...
$result = mysqli_query($conn, "SELECT users.*, books.*,user_wish_list.*  FROM user_wish_list 
                                JOIN books ON books.id = user_wish_list.book_id
                                JOIN users ON users.user_id = user_wish_list.user_id
  ...
  <section id="content-holder" class="container-fluid container">
        <section class="row-fluid features-books">
            <section class="span12 m-bottom">
                ...
                <h2><?php echo $_SESSION['name']."'s Wish List";?></h2>
