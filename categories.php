...
$bookCategories = mysqli_query($conn, "SELECT * FROM categories");
          ...
          <section class="span12 first">
                <section class="list-holder">
                    ...
                    <article class="item-holder">
                        <div class="span2">
                            <a href=""><img src="<?php echo $row['image'];?>" style="height: 207px;width: 140px;" alt="Image07" /></a> </div>
                        <div class="span10">
                            <div class="title-bar"><a href=""><?php echo $row['category']?></a></div>
